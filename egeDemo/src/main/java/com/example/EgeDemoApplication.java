...
public class EgeDemoApplication {
	
	private static final Logger logger = LoggerFactory.getLogger(EgeDemoApplication.class);


	public static void main(String[] args) {
		SpringApplication.run(EgeDemoApplication.class, args);
	}
